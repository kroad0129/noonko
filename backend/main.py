...
LAW_API_KEY = "kroad0129"  # 사용자 OC 값
...
def get_similarity():
    ...
    for rank, idx in enumerate(top_k_indices):
        ...
        result = {
            ...
            "date": case_date,  # 선고일자
            "similarity": round(top_k_similarities[rank], 4),  # 유사도
            "link": f"https://www.law.go.kr/DRF/lawService.do?OC=kroad0129&target=prec&ID={case_id}&type=HTML"
        }
